  ...
  class DeckStage extends HTMLElement {
    ...
    _render() {
      ...
      overlay.innerHTML = `
        ...
        <button class="btn reset" type="button" aria-label="Toggle fullscreen" title="Fullscreen (F)">Fullscreen<span class="kbd">F</span></button>
      `;
      ...
      try {
        ...
        if (!this._fsBound) {
          ...
          var sync = function () {
            ...
            if (fs) self.setAttribute('no-rail', ''); else self.removeAttribute('no-rail');
            if (self._syncRailHidden) self._syncRailHidden();
        ...
        if (!f) { (el.requestFullscreen || el.webkitRequestFullscreen || function(){}).call(el); }
